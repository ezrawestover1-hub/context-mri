...
- Thirty-six automated tests protecting the evaluator, classifications, aggregate claims, provenance, endpoints, guard behavior, shared diagnostic service, sanitized proof contract, and real MCP transport
