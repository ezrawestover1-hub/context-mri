...
description: Diagnose agent failures caused by conflicting, stale, unsafe, missing, or redundant context files with Context MRI, then propose and verify a minimal repair. Use for requests such as why an agent chose the wrong instruction, audit this context pack, find the file that changed the result, inspect Context MRI evidence, or verify a repaired context pack.
---
...
3. Diagnose.
   ...
   - Say “harmful for this task under this evaluator,” never “universally harmful.”
...
6. Verify.
   - Call `verify_context_pack` with the returned guard and repaired pack.
